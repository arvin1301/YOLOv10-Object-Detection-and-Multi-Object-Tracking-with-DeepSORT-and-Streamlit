...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Data science project\Object_tracking_yolov10_recording'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Data science project\Object_tracking_yolov10_recording\Scripts\deactivate.nu'
